...
% parses it into an atlas structure object. See FindCategory to see an 
% example of how the atlas object is used. The following XML format is 
% required, where the exclude, dx, and category elements are optional. 
% Finally, as shown below, multiple category elements may exist (the same
% structure may be present in multiple plan categories).
%
%  <atlas version="1.0">
%    <structure>
%       <name></name>
...
%  </atlas>
%
% This function will parse the name, include, and exclude elements as char 
...
Event(['Loading structure atlas ', filename]);
tic;
